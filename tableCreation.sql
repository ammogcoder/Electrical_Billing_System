CREATE TABLE [dbo].[CUSTOMER] (
    ...
    [dateEntered] DATE       DEFAULT (getdate()) NOT NULL,
...
insert into CUSTOMER values ('Oyesh','Singh','722 E Caston Street','Beaumont','TX',77705, 
+'USA','03/16/1989','713459320','4096005899','oyeshsin@hotmail.com','oyashi','nepal123',default);
...
insert into BILLING values (1,'January',2000,'03/01/2015',1000,110,50,'no',null);
insert into BILLING values (2,'February',2015,'03/01/2015',1011,100,100,'yes',null);
insert into BILLING values (1,'March',2015,'03/01/2015',1000,45,30,'no',null);
insert into BILLING values (1,'April',2015,'03/01/2015',1000,32,60,'no',null);

select * from BILLING;
select * from BILLING where customerID = 1 and billingMonth = 'March' and billingYear = 2015;
select * from BILLING where billingMonth = 'January' and billingYear = 2000;
select max(billingID) from BILLING;

ALTER TABLE [dbo].[BILLING] WITH NOCHECK
    ADD CONSTRAINT [FK_BILLING_CUSTOMER] FOREIGN KEY ([customerID]) REFERENCES [dbo].[CUSTOMER] ([customerId]);

ALTER TABLE [dbo].[BILLING] WITH NOCHECK
ADD CONSTRAINT [CK_BILLING_PAID] CHECK (paid = 'yes' or paid = 'no');

ALTER TABLE [dbo].[BILLING] WITH CHECK CHECK CONSTRAINT [FK_BILLING_CUSTOMER];

ALTER TABLE [dbo].[BILLING] WITH CHECK CHECK CONSTRAINT [CK_BILLING_PAID];
...
insert into tbl_state ([state_name],[state_abbr])
values
( 'Alabama', 'AL'),
( 'Alaska', 'AK'),
( 'Arizona', 'AZ'),
...
INSERT INTO [country] ([id], [name]) VALUES ('BQ', 'British Antarctic Territory');
...
INSERT INTO [country] ([id], [name]) VALUES ('CT', 'Canton and Enderbury Islands');
...
INSERT INTO [country] ([id], [name]) VALUES ('NQ', 'Dronning Maud Land');
INSERT INTO [country] ([id], [name]) VALUES ('DD', 'East Germany');
...
INSERT INTO [country] ([id], [name]) VALUES ('FQ', 'French Southern and Antarctic Territories');
...
INSERT INTO [country] ([id], [name]) VALUES ('JT', 'Johnston Island');
...
INSERT INTO [country] ([id], [name]) VALUES ('FX', 'Metropolitan France');
INSERT INTO [country] ([id], [name]) VALUES ('MX', 'Mexico');
INSERT INTO [country] ([id], [name]) VALUES ('FM', 'Micronesia');
INSERT INTO [country] ([id], [name]) VALUES ('MI', 'Midway Islands');
...
INSERT INTO [country] ([id], [name]) VALUES ('NT', 'Neutral Zone');
...
INSERT INTO [country] ([id], [name]) VALUES ('VD', 'North Vietnam');
...
INSERT INTO [country] ([id], [name]) VALUES ('PC', 'Pacific Islands Trust Territory');
...
INSERT INTO [country] ([id], [name]) VALUES ('PU', 'U.S. Miscellaneous Pacific Islands');
...
INSERT INTO [country] ([id], [name]) VALUES ('SU', 'Union of Soviet Socialist Republics');
...
INSERT INTO [country] ([id], [name]) VALUES ('WK', 'Wake Island');
